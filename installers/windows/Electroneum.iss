; Electroneum GUI Wallet Installer for Windows
...
Root: HKCU; Subkey: "Software\electroneum-project\electroneum-core"; ValueType: string; ValueName: "daemonFlags"; ValueData: {code:DaemonFlags};
